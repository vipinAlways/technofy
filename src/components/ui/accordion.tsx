...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex justify-between min-w-full">
      ...
      >
        {children}
        <ChevronDownIcon className="text-white bg-accent rounded-full  pointer-events-none  max-md:min-w-[10%] size-8 p-2  translate-y-0.5 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
