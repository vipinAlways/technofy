...
const ServiceCard = ({ cardData,href }: { cardData: ServiceCardData,href:string }) => {
  ...
  return (
    <Link
      href={href}
      className="bg-white  rounded-2xl p-6 flex flex-col items-center gap-5 border border-border max-w-[360px] group hover:shadow-[0_4px_8px_rgba(247,148,32,0.64)] transition-all duration-100 ease-linear shadow-[0_4px_8px_rgba(0,0,0,0.12)]"
    >
