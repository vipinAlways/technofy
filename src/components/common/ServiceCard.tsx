...
const ServiceCard = ({ cardData,href }: { cardData: ServiceCardData,href:string }) => {
  ...
  return (
    <Link
      href={href}
      className="bg-white rounded-2xl p-6 flex flex-col items-center gap-5 border border-border max-w-[360px] group hover:shadow-[0_4px_8px_rgba(247,148,32,0.64)] transition-all duration-100 ease-linear"
    >
      <div className="w-20 h-20 flex items-center justify-center rounded-full bg-[#3853A4]/20 group-hover:bg-[#3853A4] p-6 transition-all duration-200 ease-linear">
